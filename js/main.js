...
const frag = await (await fetch('../shaders/frag.fs')).text();
const simpleFrag = await (await fetch('../shaders/fragUI.fs')).text();
const vert = await (await fetch('../shaders/vert.vs')).text();
